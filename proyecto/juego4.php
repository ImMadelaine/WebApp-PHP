    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <!-- Columna de login-->
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="login.php">Cerrar Sesión</a>
                </li>
...
<section class="fdb-block">
  <div class="container">
    ...
    <div class="row ">
      <div class="col-6">
        <img alt="image" style="height: 360px;" class="img-fluid"  src="img/p4.jpg">
        </div>
        <div class="col-6">
